...
import { getTipReport } from '../../api/reports';
...
export default function TipReports() {
  ...
  // Define columns for the tip report
  const columns = [
    {
      header: 'Order Number',
    ...
    },
    {
      ...
      accessor: 'tip_amount',
      Cell: (row) => (
        <div className="font-medium text-green-600">₹{row.tip_amount?.toFixed(2) || '0.00'}</div>
      )
    },
    {
      header: 'Final Amount',

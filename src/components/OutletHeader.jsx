...
const OutletHeader = () => {
  ...
  return (
    <div className="bg-white py-3">
      {/* Simplified header for mobile with only outlet name */}
      <div className="flex items-center justify-between px-4">
        {/* Outlet selector button - simplified for mobile */}
        <button 
          onClick={handleOpenModal}
          className="flex items-center py-1.5 px-3 text-sm font-medium text-gray-700 focus:outline-none border border-gray-300 rounded-md bg-white hover:bg-gray-50 justify-between"
        >
        ...
        <div className="hidden md:flex md:items-center md:justify-between md:flex-1">
          {/* Date Range Picker - only visible on desktop */}
          {currentOutlet && (
            <div className="ml-4">
          ...
          {/* Right section with refresh button and profile - only visible on desktop */}

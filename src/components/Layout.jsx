...
export default function Layout({ children }) {
  ...
  const reportItems = [
    ...
    { name: 'Service Charges', path: '/reports/service-charges', icon: 'service-charge' },
    { name: 'Special Discounts', path: '/reports/special-discounts', icon: 'discount' },
    { name: 'Udhari', path: '/reports/udhari', icon: 'udhari' }   
  ];
